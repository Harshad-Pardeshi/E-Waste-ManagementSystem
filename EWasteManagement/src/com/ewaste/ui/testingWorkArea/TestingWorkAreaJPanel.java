...
public class TestingWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public TestingWorkAreaJPanel(JPanel userProcessContainer, UserAccount userAccount, TestingOrganization testingOrganization, Enterprise enterprise, Network network) {
        initComponents();
    ...
    private void assignedTaskButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_assignedTaskButtonActionPerformed
        TestingAssignedTaskPanel testingAssignedTaskPanel = new TestingAssignedTaskPanel(userProcessContainer, userAccount, testingOrganization,enterprise,network);
        userProcessContainer.add("TestingAssignedTaskPanel", testingAssignedTaskPanel);
    ...
    private void newTaskButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newTaskButtonActionPerformed
        TestingNewTaskPanel testingNewTaskPanel = new TestingNewTaskPanel(userProcessContainer, userAccount, testingOrganization, enterprise,network);
        userProcessContainer.add("testingNewTaskPanel", testingNewTaskPanel);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        layout.next(userProcessContainer);
